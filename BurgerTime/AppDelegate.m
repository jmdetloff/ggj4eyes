...
- (void)showLevel:(NSInteger)level {
    //mdsa - moved to "win" screen (where it should technically be unlocked anyway)
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"BurgerTime" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"BurgerTime.sqlite"];
